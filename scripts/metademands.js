...
(function ($) {
    $.fn.metademandWizard = function (options) {
      ...
      function init() {
         ...
         */
         this.metademand_setMandatoryField = function (toupdate, toobserve, check_value) {
            object.metademand_checkEmptyField(toupdate, toobserve, check_value);
         ...
         * @param  check_value : value to check
         */
         this.metademand_checkEmptyField = function (toupdate, toobserve, check_value) {
