...
//            if(!is_array($field)){
//               echo "<input name='field[".$id."]' type='hidden' value='".$field."'>";
//
//            }
//         }
//      }
...
//               $script .= "metademandWizard.metademand_setMandatoryField('metademands_wizard_red" . PluginMetademandsField::_unserialize($data['fields_link'])[0] . "', 'field[" . $data['id'] . "]', '" . PluginMetademandsField::_unserialize($data['check_value'])[0] . "');";
